...
a persistence unit "notificacionesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "notificaciones\pom.xml":
...
artifact ("notificaciones.war") is already built. You can build
